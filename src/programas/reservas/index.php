...
if (isset($_GET["txtID"])) {
    ...
    $sentencia = $conexion->prepare("DELETE FROM reservas WHERE id_reserva = $txtID;
");
            ...
            <div class="card-body p-4">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <i class="fas fa-plus me-2" style="font-size: 0.9rem;"></i> Crear Reserva
                        </a>
                            ...
                            <table class="table text-nowrap mb-0 align-middle">
                                ...
                                <tbody>
                                    <?php foreach ($resultado_habitaciones as $habitacion) { ?>
                                        <tr>
                                            <td><?php echo $habitacion["id_reserva"]; ?></td>
                                            <td><?php echo $habitacion["nombre_cliente"]; ?></td>
                                            <td><?php echo $habitacion["fecha_reserva"]; ?></td>
                                            <td><?php echo $habitacion["estado_reserva"]; ?></td>
                                            


                                            <td><?php echo $habitacion["descripcion_reserva"]; ?></td>
                                            <td><?php echo $habitacion["check_in_reserva"]; ?></td>
                                            <td><?php echo $habitacion["check_out_reserva"]; ?></td>
                                            <td>
                                                <a href="editar.php?txtID=<?php echo $habitacion["id_reserva"]; ?>" class="btn btn-primary btn-sm">
                                                    <i class="fa-solid fa-pencil"></i>
                                                </a>
                                                <a href="index.php?txtID=<?php echo $habitacion["id_reserva"]; ?>" class="btn btn-danger btn-sm">
