                            ...
                            <div class="card w-100">
                                <div class="card-body py-2">
                                    ...
                                    <div class="btn-create">
                                            <a href="./crear.php" class="btn btn-primary text-white">Registra un Cliente</a>
                                        </div>
                                            ...
                                            <tbody>
                                                <?php foreach ($clientes as $cliente) { ?>
                                                    <tr>
                                                        ...
                                                        <td class="border-bottom-0"><?php echo $cliente["contrasena_cliente"]; ?></td>
                                                        ...
                                                        <td class="border-bottom-0"><?php echo $cliente["fecha_registro_cliente"]; ?></td>
                                                        <td>
                                                            <a href="editar.php?id=<?php echo $cliente["id_cliente"]; ?>" class="btn btn-primary btn-sm">
                                                            <i class="fa-solid fa-pencil"></i>
                                                        </a>
                                                        <a href="eliminar.php?id=<?php echo $cliente["id_cliente"]; ?>" class="btn btn-danger btn-sm">
