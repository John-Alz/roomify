                        ...
                        <div class="col-lg-12 d-flex align-items-stretch">
                            <div class="card w-100">
                                <div class="card-body py-2">
                                    <a class="card-title fw-semibold mb-4">Servicios Adicionales</a>
                                    <div class="table-responsive">
                                        ...
                                        <table class="table text-nowrap mb-0 align-middle">
                                            ...
                                            <tbody>
                                                ...
                                                <?php foreach ($resultado_servicios as $key => $value) { ?>
                                                    <tr>
                                                        <td class="border-bottom-0">
                                                            <h6 class="fw-semibold mb-0"><?php echo $value["id_servicio_adicional"] ?></h6>
                                                        </td>
                                                        <td class="border-bottom-0">
                                                            <h6 class="fw-semibold mb-1"><?php echo $value["nombre"] ?></h6>
                                                        </td>
                                                        <td class="border-bottom-0">
                                                            <p class="mb-0 fw-normal"><?php echo $value["descripcion_servicio"] ?></p>
                                                        </td>
                                                        <td class="border-bottom-0">
                                                            <div class="d-flex align-items-center gap-2">
                                                                <span class="badge bg-primary rounded-3 fw-semibold">$<?php echo $value["costo"] ?></span>
                                                            </div>
                                                        </td>
                                                        <td class="border-bottom-0">
                                                            <!-- Enlace de edición -->
                                                            <a href="edit.php?id=<?php echo $value["id_servicio_adicional"]; ?>"
                                                                class="badge bg-warning rounded-3 fw-semibold">Editar</a>

                                                            <!-- Enlace de eliminación -->
                                                            <a href="index.php?txtID=<?php echo $value["id_servicio_adicional"] ?>"
